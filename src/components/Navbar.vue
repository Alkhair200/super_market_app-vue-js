            ...
            <li class="nav-item mr-auto">
              <a class="navbar-brand" href="index.html">
                <img
                  ...
                  src="dashboard/app-assets/images/logo/logo.png"
                />
                <h3 class="brand-text">نظام سوبر ماركت</h3>
              </a>
            </li>
                    ...
                    <div id="mega-menu-carousel-example">
                      <div>
                        <img
                          ...
                          src="dashboard/app-assets/images/slider/slider-2.png"
                          alt="First slide"
                        /><a class="news-title mb-0" href="#"
                          >Poster Frame PSD</a
                        >
                        ...
                        <ul>
                          <li>
                            <a
                              ...
                              ><i class="ft-file"></i> Page layouts &
                              Templates</a
                            >
                          </li>
                          <li>
                            ...
                            <ul>
                              <li>
                                <a class="dropdown-item" href="#"
                                  ><i class="la la-bookmark-o"></i> Second
                                  level</a
                                >
                              </li>
                              <li>
                                <a href="#"
                                  ><i class="la la-lemon-o"></i> Second level
                                  menu</a
                                >
                                <ul>
                                  <li>
                                    <a class="dropdown-item" href="#"
                                      ><i class="la la-heart-o"></i> Third
                                      level</a
                                    >
                                  </li>
                                  <li>
                                    <a class="dropdown-item" href="#"
                                      ><i class="la la-file-o"></i> Third
                                      level</a
                                    >
                                  </li>
                                  <li>
                                    <a class="dropdown-item" href="#"
                                      ><i class="la la-trash-o"></i> Third
                                      level</a
                                    >
                                  </li>
                                  <li>
                                    <a class="dropdown-item" href="#"
                                      ><i class="la la-clock-o"></i> Third
                                      level</a
                                    >
                                  </li>
                                </ul>
                              ...
                              <li>
                                <a class="dropdown-item" href="#"
                                  ><i class="la la-hdd-o"></i> Second level,
                                  third link</a
                                >
                              </li>
                              <li>
                                <a class="dropdown-item" href="#"
                                  ><i class="la la-floppy-o"></i> Second level,
                                  fourth link</a
                                >
                              </li>
                            </ul>
                          ...
                          <li>
                            <a
                              ...
                              ><i class="ft-camera"></i> Color palette system</a
                            >
                          </li>
                          <li>
                          ...
                          <li>
                            <a
                              ...
                              ><i class="la la-life-ring"></i> Customer support
                              center</a
                            >
                          </li>
                        </ul>
            ...
            <ul class="nav navbar-nav float-right">
              <li class="dropdown dropdown-user nav-item">
                ...
                >
                  <span class="mr-1"
                    >مرحبا,
                    <span class="user-name text-bold-700" v-if="getUser">{{
                      getUser.name
                    }}</span>
                  </span>
                  <span class="avatar avatar-online">
                    <img
                      src="dashboard/app-assets/images/portrait/small/avatar-s-19.png"
                      alt="avatar" /><i></i
                  ></span>
                </a>
                <div
                ...
                >
                  <router-link class="dropdown-item" to="/users"
                    ><i class="ft-user"></i> تعديل بروفايل
                  </router-link>
