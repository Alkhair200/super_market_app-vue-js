      ...
      <div class="main-menu-content">
        ...
        >
                ...
                <ul class="menu-content">
                  <li>
                    <a
                      ...
                      data-i18n="nav.templates.horz.classic"
                      >Classic</a
                    >
                  </li>
                  <li>
          ...
          <li class="navigation-header">
            ...
            ><i
              class="la la-ellipsis-h ft-minus"
              data-toggle="tooltip"
          ...
          <li class="nav-item">
            <a href="#"
              ...
              ><span class="menu-title" data-i18n="nav.page_layouts.main"
                >Page layouts</span
              ><span
          ...
          <li class="nav-item">
            <a href="#"
              ...
              ><span class="menu-title" data-i18n="nav.vertical_nav.main"
                >Vertical Nav</span
              ></a
            >
            <ul class="menu-content">
                ...
                <ul class="menu-content">
                  ...
                  <li>
                    <a
                      ...
                      data-i18n="nav.vertical_nav.vertical_navigation_types.vertical_modern-menu"
                      >Vertical Modern Menu</a
                    >
                  </li>
                  <li>
                    <a
          ...
          <li class="nav-item">
            <a href="#"
              ...
              ><span class="menu-title" data-i18n="nav.page_headers.main"
                >Page Headers</span
              ></a
            >
            <ul class="menu-content">
          ...
          <li class="nav-item">
            <a href="#"
              ...
              ><span class="menu-title" data-i18n="nav.footers.main"
                >Footers</span
              ></a
            >
            <ul class="menu-content">
          ...
          <li class="nav-item">
            <a href="#"
              ...
              ><span class="menu-title" data-i18n="nav.starter_kit.main"
                >Starter kit</span
              ></a
            >
            <ul class="menu-content">
          ...
          <li class="nav-item">
            <a href="changelog.html"
              ...
              ><span class="menu-title" data-i18n="nav.changelog.main"
                >Changelog</span
          ...
          <li class="disabled nav-item">
            <a href="#"
              ...
              ><span class="menu-title" data-i18n="nav.disabled_menu.main"
                >Disabled Menu</span
              ></a
            >
          </li>
          <li class="nav-item">
            <a href="#"
              ...
              ><span class="menu-title" data-i18n="nav.menu_levels.main"
                >Menu levels</span
              ></a
            >
            <ul class="menu-content">
          ...
          <li class="nav-item">
            <a href="email-application.html"
              ...
              ><span class="menu-title" data-i18n="">Email Application</span></a
            >
          </li>
          <li class="nav-item">
            <a href="chat-application.html"
              ><i class="la la-comments"></i
              ><span class="menu-title" data-i18n="">Chat Application</span></a
            >
          </li>
          <li class="nav-item">
            <a href="#"
              ><i class="la la-briefcase"></i
              ><span class="menu-title" data-i18n="nav.project.main"
                >Project</span
              ></a
            >
            <ul class="menu-content">
          ...
          <li class="nav-item">
            <a href="scrumboard.html"
              ...
              ><span class="menu-title" data-i18n="nav.scrumboard.main"
                >Scrumboard</span
              ><span class="badge badge badge-info float-right">Update</span></a
            >
          </li>
          <li class="nav-item">
            <a href="#"
              ><i class="la la-clipboard"></i
              ><span class="menu-title" data-i18n="nav.invoice.main"
                >Invoice</span
              ></a
            >
            <ul class="menu-content">
          ...
          <li class="nav-item">
            <a href="#"
              ...
              ><span class="menu-title" data-i18n="nav.timelines.main"
                >Timelines</span
              ></a
            >
            <ul class="menu-content">
          ...
          <li class="nav-item">
            <a href="#"
              ...
              ><span class="menu-title" data-i18n="nav.gallery_pages.main"
                >Gallery</span
              ></a
            >
            <ul class="menu-content">
          ...
          <li class="nav-item">
            <a href="#"
              ...
              ><span class="menu-title" data-i18n="nav.search_pages.main"
                >Search</span
              ></a
            >
            <ul class="menu-content">
          ...
          <li class="nav-item">
            <a href="#"
              ...
              ><span class="menu-title" data-i18n="nav.error_pages.main"
                >Error</span
              ></a
            >
            <ul class="menu-content">
          ...
          <li class="nav-item">
            <a href="#"
              ...
              ><span class="menu-title" data-i18n="nav.other_pages.main"
                >Others</span
              ></a
            >
            <ul class="menu-content">
          ...
          <li class="nav-item">
            <a href="#"
              ...
              ><span class="menu-title" data-i18n="nav.cards.main">Cards</span
          ...
          <li class="nav-item">
            <a href="#"
              ...
              ><span class="menu-title" data-i18n="nav.advance_cards.main"
                >Advance Cards</span
              ></a
            >
            <ul class="menu-content">
          ...
          <li class="nav-item">
            <a href="#"
              ...
              ><span class="menu-title" data-i18n="nav.content.main"
                >Content</span
              ></a
            >
            <ul class="menu-content">
          ...
          <li class="nav-item">
            <a href="#"
              ...
              ><span class="menu-title" data-i18n="nav.components.main"
                >Components</span
              ></a
            >
            <ul class="menu-content">
              ...
              <li>
                <a class="menu-item" href="component-pill-badges.html"
                  >Pill Badges</a
                >
              </li>
              <li>
              ...
              <li>
                <a
                  ...
                  data-i18n="nav.components.component_spinners"
                  >Spinners</a
                >
              </li>
            </ul>
          ...
          <li class="nav-item">
            <a href="#"
              ...
              ><span class="menu-title" data-i18n="nav.extra_components.main"
          ...
          <li class="nav-item">
            <a href="#"
              ><i class="la la-eye"></i
              ><span class="menu-title" data-i18n="nav.icons.main"
                >Icons</span
              ></a
            >
            <ul class="menu-content">
              ...
              <li>
                <a
                  ...
                  data-i18n="nav.icons.icons_line_awesome"
                  >Line Awesome</a
                >
              </li>
              <li>
          ...
          <li class="nav-item">
            <a href="animation.html"
              ...
              ><span class="menu-title" data-i18n="nav.animation.main"
                >Animation</span
              ></a
            >
          </li>
          ...
          <li class="nav-item">
            <a href="#"
              ...
              ><span class="menu-title" data-i18n="nav.form_elements.main"
                >Form Elements</span
              ></a
            >
            <ul class="menu-content">
          ...
          <li class="nav-item">
            <a href="#"
              ><i class="la la-file-text"></i
              ><span class="menu-title" data-i18n="nav.form_layouts.main"
                >Form Layouts</span
              ></a
            >
            <ul class="menu-content">
          ...
          <li class="nav-item">
            <a href="#"
              ...
              ><span class="menu-title" data-i18n="nav.form_wizard.main"
                >Form Wizard</span
              ></a
            >
            <ul class="menu-content">
          ...
          <li class="nav-item">
            <a href="form-repeater.html"
              ...
              ><span class="menu-title" data-i18n="nav.form_repeater.main"
                >Form Repeater</span
              ></a
            >
          </li>
          ...
          <li class="nav-item">
            <a href="#"
              ...
              ><span class="menu-title" data-i18n="nav.bootstrap_tables.main"
          ...
          <li class="nav-item">
            <a href="#"
              ><i class="la la-th"></i
              ><span class="menu-title" data-i18n="nav.data_tables.main"
                >DataTables</span
              ></a
            >
            <ul class="menu-content">
          ...
          <li class="nav-item">
            <a href="#"
              ...
              ><span class="menu-title" data-i18n="nav.handson_table.main"
                >Handson Table</span
              ></a
            >
            <ul class="menu-content">
          ...
          <li class="nav-item">
            <a href="table-jsgrid.html"
              ><i class="la la-table"></i
              ><span class="menu-title" data-i18n="nav.table_jsgrid.main"
                >jsGrid</span
              ></a
            >
          </li>
          ...
          <li class="nav-item">
            <a href="#"
              ...
              ><span class="menu-title" data-i18n="nav.editors.main"
                >Editors</span
              ></a
            >
            <ul class="menu-content">
          ...
          <li class="nav-item">
            <a href="#"
              ...
              ><span class="menu-title" data-i18n="nav.pickers.main"
                >Pickers</span
              ></a
            >
            <ul class="menu-content">
          ...
          <li class="nav-item">
            <a href="#"
              ...
              ><span class="menu-title" data-i18n="nav.jquery_ui.main"
                >jQuery UI</span
              ></a
            >
            <ul class="menu-content">
          ...
          <li class="nav-item">
            <a href="add-on-block-ui.html"
              ><i class="la la-terminal"></i
              ><span class="menu-title" data-i18n="nav.add_on_block_ui.main"
                >Block UI</span
              ></a
            >
          </li>
          ...
          <li class="nav-item">
            <a href="#"
              ...
              ><span class="menu-title" data-i18n="nav.file_uploaders.main"
                >File Uploader</span
              ></a
            >
            <ul class="menu-content">
          ...
          <li class="nav-item">
            <a href="#"
              ><i class="la la-calendar"></i
              ><span class="menu-title" data-i18n="nav.event_calendars.main"
          ...
          <li class="nav-item">
            <a href="#"
              ...
              ><span class="menu-title" data-i18n="nav.google_charts.main"
                >google Charts</span
              ></a
            >
            <ul class="menu-content">
          ...
          <li class="nav-item">
            <a href="#"
              ...
              ><span class="menu-title" data-i18n="nav.echarts.main"
                >Echarts</span
              ></a
            >
            <ul class="menu-content">
          ...
          <li class="nav-item">
            <a href="#"
              ...
              ><span class="menu-title" data-i18n="nav.chartjs.main"
                >Chartjs</span
              ></a
            >
            <ul class="menu-content">
          ...
          <li class="nav-item">
            <a href="#"
              ...
              ><span class="menu-title" data-i18n="nav.d3_charts.main"
                >D3 Charts</span
              ></a
            >
            <ul class="menu-content">
          ...
          <li class="nav-item">
            <a href="#"
              ...
              ><span class="menu-title" data-i18n="nav.c3_charts.main"
                >C3 Charts</span
              ></a
            >
            <ul class="menu-content">
          ...
          <li class="nav-item">
            <a href="#"
              ...
              ><span class="menu-title" data-i18n="nav.chartist.main"
                >Chartist</span
              ></a
            >
            <ul class="menu-content">
          ...
          <li class="nav-item">
            <a href="morris-charts.html"
              ...
              ><span class="menu-title" data-i18n="nav.morris_charts.main"
                >Morris Charts</span
              ></a
            >
          </li>
          <li class="nav-item">
            <a href="#"
              ...
              ><span class="menu-title" data-i18n="nav.flot_charts.main"
                >Flot Charts</span
              ></a
            >
            <ul class="menu-content">
          ...
          <li class="nav-item">
            <a href="rickshaw-charts.html"
              ...
              ><span class="menu-title" data-i18n="nav.rickshaw_charts.main"
          ...
          <li class="nav-item">
            <a href="#"
              ><i class="la la-map"></i
              ><span class="menu-title" data-i18n="nav.maps.main">Maps</span></a
            >
            <ul class="menu-content">
              <li>
                <a
