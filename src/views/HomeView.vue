            ...
            <div class="col-xl-6 col-12">
              <div class="row">
                ...
                <div class="col-lg-6 col-12">
                  <div class="card pull-up">
                    <div
                      class="card-content collapse show bg-gradient-directional-danger"
                    >
                      ...
                      <div class="card-body">
                        <div class="media d-flex">
                          ...
                          <div class="align-self-center">
                            <i
                              class="icon-trophy success font-large-2 float-right"
                            ></i>
                          </div>
                        </div>
                      </div>
                    ...
                    <div class="card-content">
                      <div class="card-body">
                        <div class="media d-flex">
                          ...
                          <div class="align-self-center">
                            <i
                              class="icon-call-in danger font-large-2 float-right"
                            ></i>
                          </div>
                        </div>
                      </div>
              ...
              <div class="card">
                <div class="card-content">
                  <div class="earning-chart position-relative">
                    ...
                    >
                      <a href="#" class="btn round btn-danger mr-1 btn-glow"
                        >Statistics <i class="ft-bar-chart"></i
                      ></a>
                      <span class="text-muted"
                        >for the
                        <a href="#" class="danger darken-2">last year.</a></span
                      >
                    </div>
                  </div>
                </div>
                            ...
                            <ul class="list-unstyled users-list m-0">
                              ...
                              >
                                <img
                                  ...
                                  src="dashboard/app-assets/images/portrait/small/avatar-s-4.png"
                                  alt="Avatar"
                                />
                              </li>
                              <li
                              ...
                              >
                                <img
                                  class="media-object rounded-circle"
                                  src="dashboard/app-assets/images/portrait/small/avatar-s-5.png"
                                  alt="Avatar"
                                />
                              </li>
                              <li
                              ...
                              >
                                <img
                                  class="media-object rounded-circle"
                                  src="dashboard/app-assets/images/portrait/small/avatar-s-6.png"
                                  alt="Avatar"
                                />
                              </li>
                          ...
                          <td class="text-truncate p-1">
                            <ul class="list-unstyled users-list m-0">
                              ...
                              >
                                <img
                                  class="media-object rounded-circle"
                                  src="dashboard/app-assets/images/portrait/small/avatar-s-7.png"
                                  alt="Avatar"
                                />
                              </li>
                              <li
                              ...
                              >
                                <img
                                  class="media-object rounded-circle"
                                  src="dashboard/app-assets/images/portrait/small/avatar-s-8.png"
                                  alt="Avatar"
                                />
                              </li>
                              <li class="avatar avatar-sm">
                          ...
                          <td class="text-truncate p-1">
                            <ul class="list-unstyled users-list m-0">
                              ...
                              >
                                <img
                                  class="media-object rounded-circle"
                                  src="dashboard/app-assets/images/portrait/small/avatar-s-1.png"
                                  alt="Avatar"
                                />
                              </li>
                              <li
                              ...
                              >
                                <img
                                  class="media-object rounded-circle"
                                  src="dashboard/app-assets/images/portrait/small/avatar-s-2.png"
                                  alt="Avatar"
                                />
                              </li>
                              <li
                              ...
                              >
                                <img
                                  class="media-object rounded-circle"
                                  src="dashboard/app-assets/images/portrait/small/avatar-s-3.png"
                                  alt="Avatar"
                                />
                              </li>
                              <li class="avatar avatar-sm">
                          ...
                          <td class="text-truncate p-1">
                            <ul class="list-unstyled users-list m-0">
                              ...
                              >
                                <img
                                  class="media-object rounded-circle"
                                  src="dashboard/app-assets/images/portrait/small/avatar-s-11.png"
                                  alt="Avatar"
                                />
                              </li>
                              <li
                              ...
                              >
                                <img
                                  class="media-object rounded-circle"
                                  src="dashboard/app-assets/images/portrait/small/avatar-s-12.png"
                                  alt="Avatar"
                                />
                              </li>
                            </ul>
                      ...
                      <div class="card-body text-center">
                        ...
                        <div class="row">
                          <div class="col-12">
                            ...
                            <div
                              id="sessions-browser-donut-chart"
                              class="height-200"
                            ></div>
                          </div>
                          <div class="col-12">
